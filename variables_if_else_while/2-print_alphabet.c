...
*as "c" is less than 123. Inside the loop,
*the putchar() function is used to
*print the character corresponding to
*the current value of "c". The value of "c"
*is then incremented by 1 at the end of each iteration. The values 97 to
